...
public class ListBeanResultSetHandler implements ResultSetHandler {
	private final Logger logger = LogFactory.getLog(SimpleBeanResultSetHandler.class);
	private Map<String,String> keyMap;
	public ListBeanResultSetHandler(){
	 ...
	 * @param map
	 */
	public ListBeanResultSetHandler(Map<String,String> keyMap){
		this.keyMap = keyMap;
	}
	@Override
	public Object handle(ResultSet rs, Class clazz)
